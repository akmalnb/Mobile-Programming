package umn.ac.id.week09_31187;
...
public class DetilActivity extends AppCompatActivity {
    ...
    public void simpanData(View view){
        ...
        if(mNIM.length() <= 0 || mNama.length() <= 0 ||mEmail.length() <= 0 || mNoHp.length() <= 0){Toast.makeText(this,"Semua harus Diisi", Toast.LENGTH_LONG).show();
        } else {
